...
public class KartController : MonoBehaviour
{
   ...
   public void ApplyAcceleration(float input)
   {
      ...
      speed = 0f;
      currentRotate = Mathf.Lerp(currentRotate, rotate, Time.deltaTime * 40f);
      rotate = 0f;
   }
   ...
   public void Respawn()
   {
        ...
        Quaternion rotationDifference = _spawnPointManager.transform.rotation * Quaternion.Inverse(transform.rotation);
        sphere.velocity = rotationDifference * sphere.velocity;
        sphere.angularVelocity = rotationDifference * sphere.angularVelocity;
        transform.rotation = _spawnPointManager.transform.rotation;
